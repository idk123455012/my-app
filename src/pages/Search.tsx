  ...
  return (
    <div className="pb-8 px-6 md:px-10 pt-8 max-w-[1600px] mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
        {filtered.map((c) => (
          <Link key={c.id} to={`/college/${c.id}`} className="bg-surfaceMid border border-borderC rounded-xl p-4 flex items-center gap-3 hover:border-cmBlue/40 transition-colors">
