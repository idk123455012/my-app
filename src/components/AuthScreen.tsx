...
export default function AuthScreen() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-6 py-10">
      <div className="w-24 h-24 rounded-full bg-gradient-to-br from-indigo-900 to-purple-900 flex items-center justify-center text-5xl shadow-lg shadow-cmBlue/40 mb-6">
        🎓
      </div>
      ...
      <div className="w-full max-w-sm bg-surfaceMid border border-borderC rounded-xl p-6">
        ...
        <p className="text-center text-[11px] text-textTertiary mb-5">🔒 No password needed</p>
        ...
        >
          <div className="font-semibold text-textSecondary text-sm">👤 Continue without an account</div>
