...
export default function Profile() {
  ...
  return (
    <div className="pb-24 px-5 pt-6">
      ...
      {tab === 'Activities' && (
        <div className="flex flex-col gap-4">
          <Card title="Extracurricular Activities" icon="⭐">
            <ListField
          ...
          <Card title="Volunteer Hours" icon="🤝">
      ...
      {tab === 'Financial' && (
        <div className="flex flex-col gap-4">
          <Card title="Financial Planning" icon="💲">
      ...
      {tab === 'Preferences' && (
        <div className="flex flex-col gap-4">
          <Card title="College Preferences" icon="⚙️">
            <p className="text-sm text-textSecondary">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-cmBlue to-indigo-600 text-white font-bold py-4 rounded-xl mt-6 disabled:opacity-40"
      >
        🔍 Find My Colleges
      </button>
    </div>
